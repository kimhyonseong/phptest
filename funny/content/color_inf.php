<?php
    ...
    else if ($color_get==$table['Tables_in_color'])      //정상 내용 - 테이블 이름이 있다면 출력
    {
        ...
        $color_ev_all = mysqli_fetch_array($query_color_ev_all);
        ...
        else                                                //비로그인상태, 평가 안했을 시 별 상태
        {
            ...
            echo '</div>';
        echo '</div>';
        echo '<div style="left: 30%; position: relative; width: 40%; height:100px; text-align: center"><div style="float: left">Comment</div><br>';
